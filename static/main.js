...
var share_message = "Check my TFT Set 4.5 performance";
var app_url = "https://get.tacter.app/KWRiClhutfb";
var api_url = "https://prod.tacter.app/tft/v1";
...
function printInformation(data) {
  ...
  $(data.champions).each(function () {
    html_champions +=
      ...
      '<img src="' +
      this.iconURL +
      '" class="icon"><b><span class="number" data-number="' +
      this.games +
      '">0</span> games</b>' +
      this.rank +
      "% top 4</div>";
  ...
  var html_items_aux =
    '&nbsp; <img src="' +
    data.champions[0].iconURL +
    '" title="' +
    data.champions[0].name +
    '" style="cursor:help;" align="absmiddle" width="30" height="30" class="icon"> ';
  html_items_aux +=
    '<img src="' +
    data.items[0].iconURL +
    '" title="' +
    data.items[0].name +
    '" style="cursor:help;" align="absmiddle" width="30" height="30" class="icon"> ';
  ...
  $(data.placements).each(function (i, value) {
    ...
    html_placements +=
      ...
      value +
      ' <div class="graph" data-number="' +
      current_value +
      '" style="background:' +
      current_color +
      ';width:10px;margin:10px auto;display:block;height:0;font-size:0;">&nbsp;</div></td>';
  });
...
$(function () {
  $("#form_username").submit(function (e) {
    ...
    window.history.pushState(
      "new url",
      document.title,
      "/?summonerName=" + username + "&region=" + region
    );
  ...
  $(".btn_share").click(function () {
    ...
    if (network == "twitter") {
      share_url =
        ...
        encodeURIComponent(share_message) +
    ...
    if (network == "whatsapp") {
      share_url =
        "whatsapp://send?text=" +
        encodeURIComponent(share_message + " " + share_url);
    }
